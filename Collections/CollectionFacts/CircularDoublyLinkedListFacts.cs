...
public class CircularDoublyLinkedListFacts
{
    ...
    [Fact]
    public void AddNewNodeFromAnotherListAfterNode()
    {
        CircularDoublyLinkedList<int> list = new();
        list.Add(1);
        list.Add(2);
        ...
        CircularDoublyLinkedList<int> list2 = new();
        list2.Add(1);
        list2.Add(2);
        list2.Add(3);
        list2.Add(4);

        Assert.Throws<InvalidOperationException>(() =>  list.AddBefore(list.Find(2), list2.Find(2)));
    }
    ...
    public void AddNewNodeBeforeANonExistingOne()
    {
        ...
        var node = new Node<int>(9);
        Assert.Throws<ArgumentNullException>(() => list.AddAfter(nextNode, node));
    }
    ...
    {
        CircularDoublyLinkedList<int> list = new CircularDoublyLinkedList<int> { 5, 1, 2, 3, 4 };
        var node = list.Find(2);
        list.Remove(node);
        
        Assert.Equal(new CircularDoublyLinkedList<int>{5, 1, 3, 4}, list);
    }
}